...
import Minimax.MinimaxImproved;
import Minimax.Minimax_Tic;
...
public class OnePlayer extends JFrame {
	...
	public void checkWin(int row, int colunm) {
		boolean checkMark = boardTic.placeMark(row, colunm);
		for (int i = 0; i < 3; i ++) {
			for (int j = 0; j < 3; j ++)
				System.out.print(boardTic.getMarkAt(i, j) + " ");
			System.out.println("");
		}
		System.out.println("-------");
		if (checkMark) {
	...
	public OnePlayer() {
			...
			public void actionPerformed(ActionEvent e) {
				if (level) {
					if (!boardTic.isTileMarked(0, 0)) {
						...
						checkWin(0, 0);
						if (!check) {
							int bestMove[] = Minimax_Tic.getBestMove(boardTic);
					...
					if (!boardTic.isTileMarked(0, 0)) {
						...
						checkWin(0, 0);
						if (!check) {
							int bestMove[] = MinimaxImproved.getBestMove(boardTic);
							System.out.println(bestMove[0] + " " + bestMove[1]);
							if (bestMove[0] == 0 && bestMove[1] == 1) {
								btn2.setText("O");
							} else if (bestMove[0] == 0 && bestMove[1] == 2) {
				...
				if (level) {
					if (!boardTic.isTileMarked(0, 1)) {
						...
						if (!check) {
							...
							checkWin(bestMove[0], bestMove[1]);
							System.out.println(boardTic.isCrossTurn());
						}
					}
				} else {
					if (!boardTic.isTileMarked(0, 1)) {
		...
		btnBacktoMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boardTic = new board();
				check = false;
				OnePlayer.this.dispose();
				//OnePlayer.this.setVisible(false);
			}
		});
		...
		lblNewLabel.setBounds(72, 20, 157, 31);
		panel_2.add(lblNewLabel);
		lblNewLabel.setForeground(new Color(41, 139, 200));
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 25));
		
		JPanel panel_3 = new JPanel();
		panel_3.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "1 Player", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panel_3.setBounds(10, 77, 261, 124);
		panel_2.add(panel_3);
		panel_3.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("PLAYER O");
		lblNewLabel_2.setBounds(22, 69, 123, 31);
		panel_3.add(lblNewLabel_2);
		lblNewLabel_2.setForeground(new Color(41, 139, 200));
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		
		JLabel lblNewLabel_1 = new JLabel("PLAYER X");
		lblNewLabel_1.setBounds(22, 28, 123, 31);
		panel_3.add(lblNewLabel_1);
		lblNewLabel_1.setForeground(new Color(41, 139, 200));
		...
		textField_countX.setBounds(136, 28, 100, 30);
		panel_3.add(textField_countX);
		
		textField_countO = new JTextField();
		textField_countO.setToolTipText("");
		textField_countO.setText("0");
		...
		textField_countO.setBounds(136, 69, 100, 30);
